...
SENSOR_ROLES = {
    ...
    'ecowitt_weather_solar_radiation': 'core_periodic',
    'sensor.ecowitt_weather_wind_speed': 'core_periodic',
    'ecowitt_weather_wind_speed': 'core_periodic',
    'sensor.ecowitt_weather_humidity': 'core_periodic',
    'ecowitt_weather_humidity': 'core_periodic',

    # Room temperature sensors (with prefix for HA, without for Grafana)
    'sensor.living_room_temp_humidity_temperature': 'room_temp',
    'living_room_temp_humidity_temperature': 'room_temp',
    'sensor.playroom_temp_humidity_sensor_temperature': 'room_temp',
    'playroom_temp_humidity_sensor_temperature': 'room_temp',
    'sensor.main_bedroom_temperature': 'room_temp',
    'main_bedroom_temperature': 'room_temp',
    'sensor.oisin_s_bedroom_temp_humidity_sensor_temperature': 'room_temp',
    'oisin_s_bedroom_temp_humidity_sensor_temperature': 'room_temp',
    'sensor.caoimhe_s_room_temp_humidity_sensor_temperature': 'room_temp',
    'caoimhe_s_room_temp_humidity_sensor_temperature': 'room_temp',
    'sensor.ecowitt_weather_indoor_temperature': 'room_temp',
    'ecowitt_weather_indoor_temperature': 'room_temp',
    'sensor.heat_pump_temp_humidity_sensor_temperature': 'room_temp',
    'heat_pump_temp_humidity_sensor_temperature': 'room_temp',
    ...
    # Binary state sensors (with prefix for HA, without for Grafana)
    'binary_sensor.underfloor_pump': 'binary_state',
    'underfloor_pump': 'binary_state',
    'binary_sensor.downstairs_radiator_pump': 'binary_state',
    'downstairs_radiator_pump': 'binary_state',
    'binary_sensor.upstairs_radiator_pump': 'binary_state',
    'upstairs_radiator_pump': 'binary_state',
